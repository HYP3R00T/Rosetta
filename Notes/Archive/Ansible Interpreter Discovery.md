...
I got the following warning when I didn't have [[Ansible Configuration.md|Ansible Configuration.md]] properly configured. It didn't have any Python interpreter setting. 
